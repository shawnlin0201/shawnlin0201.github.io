---
title: Vue.js學習系列(四)components(Registration, child component and template)
...
```
# 結尾
`components`部分有很多有趣的東西，這篇主要講了基本的註冊、子元件以及樣板設定，對於整個元件系統來說才算初入茅廬而已，而接下來下一篇將會講解元件與元件之間要如何做溝通、如何檢查溝通中所傳遞的資料以及說明單向資料流部分，點選這裡來[前往下個章節](https://shawnlin0201.github.io/2019/07/10/Vue-js-note-005/)！
