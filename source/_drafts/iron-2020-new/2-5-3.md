...
當我們從馬克杯解析成圓柱體以及手把的兩個幾何子時，我們稱這段處理歷程過程為 **由上而下的處理歷程（top-down processing）**，也就是從較大的範圍逐漸拆解成較小的範圍來覺察；相反地，如果是從圓柱體和手把形狀拼湊成馬克杯時，我們則稱為是 **由下而上的處理歷程（Bottom-Up Processing）**。
